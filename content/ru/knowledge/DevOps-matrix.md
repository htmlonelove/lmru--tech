...
|Моделирование угроз | Используется моделирование угроз. - Все текущие компоненты оценены по рекомендованной методике. - Все новые компоненты проходят оценку по рекомендованной методике | | | |+ | |
