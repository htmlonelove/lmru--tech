...
|Моделирование угроз | Используется моделирование угроз. \n [^1]: Все текущие компоненты оценены по рекомендованной методике. \n [^2]: Все новые компоненты проходят оценку по рекомендованной методике | | | |+ | |
